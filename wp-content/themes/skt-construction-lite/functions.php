...
define('SKT_URL','http://www.sktthemes.net','skt-construction');
define('SKT_THEME_URL','http://www.sktthemes.net/themes','skt-construction');
define('SKT_THEME_URL_DIRECT','http://www.sktthemes.net/shop/responsive-construction-wordpress-theme/','skt-construction');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/skt-construction-doc/','skt-construction');
define('SKT_PRO_THEME_URL','http://www.sktthemes.net/shop/responsive-construction-wordpress-theme/','skt-construction');
define('SKT_THEME_FEATURED_SET_VIDEO_URL','https://www.youtube.com/watch?v=310YGYtGLIM','skt-construction');
define('SKT_PRO_FONT_AWESOME_URL','http://fortawesome.github.io/Font-Awesome/icons/','skt-construction');
define('SKT_LIVE_DEMO','http://sktthemesdemo.net/skt-construction-pro/','skt-construction');

function skt_construction_credit(){
		return "&copy; 2016 <span>SKT Construction</span>. All Rights Reserved";
}
function skt_construction_themebytext(){
		return "Theme by <a rel='nofollow' href=".esc_url(SKT_URL)." target='_blank'>SKT Themes</a>";
}
/**
 ...
 *
 */
function skt_construction_the_custom_logo() {
