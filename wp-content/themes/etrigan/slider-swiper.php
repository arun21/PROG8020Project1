...
if ( get_theme_mod('etrigan_main_slider_enable' ) && is_home() ) :

	$count_x = $count = get_theme_mod('etrigan_main_slider_count');
			...
			<div class="container">
				<div class="slider-container theme-default">
			            ...
			            for ( $i = 1; $i <= $count; $i++ ) :
							...
							$url = esc_url ( get_theme_mod('etrigan_slide_url'.$i) );
							$img = esc_url ( get_theme_mod('etrigan_slide_img'.$i) );
							$title = esc_html( get_theme_mod('etrigan_slide_title'.$i) );
							$desc = esc_html( get_theme_mod('etrigan_slide_desc'.$i) );
